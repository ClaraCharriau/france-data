...
class _SvgMapState extends State<SvgMap> {
  ...
  final Widget compiledSvgMap =
      const SvgPicture(AssetBytesLoader('web/assets/img/france.svg.vec'));

  final Widget svgMap = SvgPicture.asset('web/assets/img/france.svg',
